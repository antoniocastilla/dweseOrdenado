            ...
            <div class="container">
                <form action="doinsert.php" method="post">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" id="nombre" name="nombre" value="<?= $usuario->getNombre() ?>" placeholder="Introduce el nombre del usuario">
                    </div>
                    <div class="form-group">
                        <label for="correo">Correo electrónico</label>
                        <input required type="email" class="form-control" id="correo" name="correo" value="<?= $usuario->getCorreo() ?>" placeholder="Introduce el correo del usuario">
                    </div>
                    <div class="form-group">
                        <label for="alias">Alias</label>
                        <input type="text" class="form-control" id="alias" name="alias" value="<?= $usuario->getAlias() ?>" placeholder="Introduce el alias del usuario">
                    </div>
                    <hr>
                    <div class="form-group">
