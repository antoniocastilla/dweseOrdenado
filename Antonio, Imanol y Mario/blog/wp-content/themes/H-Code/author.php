                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                        ...
                        <div class="row mymargin-bottom">
                                <div class="progress-bar-main col-md-8 center-col">
                                        <!-- progress bar item -->
                                        <div class="progress-bar-sub">
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo the_author_meta('sk1', $curauth->ID); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo the_author_meta('sk1', $curauth->ID); ?>%;"></div>
                                            </div>
                                            <div class="progress-name"><strong><?php _e('Web Development', langdomain()); ?></strong></div>
                                        </div>
                                        <!-- end progress bar item -->
                                        <!-- progress bar item -->
                                        <div class="progress-bar-sub">
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo the_author_meta('sk2', $curauth->ID); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo the_author_meta('sk2', $curauth->ID); ?>%;"></div>
                                            </div>
                                            <div class="progress-name"><strong><?php _e('Web Design', langdomain()); ?></strong></div>
                                        </div>
                                        <!-- end progress bar item -->
                                        <!-- progress bar item -->
                                        <div class="progress-bar-sub">
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo the_author_meta('sk3', $curauth->ID); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo the_author_meta('sk3', $curauth->ID); ?>%;"></div>
                                            </div>
                                            <div class="progress-name"><strong><?php _e('Graphic Design', langdomain()); ?></strong></div>
                                        </div>
                                        <!-- end progress bar item -->
                                        <!-- progress bar item -->
                                        <div class="progress-bar-sub">
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="<?php echo the_author_meta('sk4', $curauth->ID); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo the_author_meta('sk4', $curauth->ID); ?>%;"></div>
                                            </div>
                                            <div class="progress-name"><strong><?php _e('Marketing', langdomain()); ?></strong></div>
                                        </div>
                                        <!-- end progress bar item -->
                                    </div>
                        </div>
