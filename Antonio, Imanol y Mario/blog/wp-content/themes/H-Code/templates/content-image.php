...
<div class="blog-listing blog-listing-classic wow fadeIn">
    ...
    <!-- post image -->
    <div class="blog-image"><a href="<?php echo get_the_permalink(); ?>"><img src="<?php echo get_first_image();?>" alt=""/></a></div>
    <!-- end post image -->
    <div class="blog-details">
        ...
        <a class="highlight-button btn btn-small xs-no-margin-bottom" href="<?php echo get_the_permalink(); ?>"><?php _e('View', langdomain()); ?></a>
    </div>
</div>